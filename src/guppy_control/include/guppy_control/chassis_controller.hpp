...
class ChassisController {
  ...
  */
  ...
  /*
      @brief update the current robot position/orientation/velocity state from a
     Odometry message
 ...
 private:
  ...
  /* the current orientation state of the submarine as a quaternion (updated by
   * Odometry messages) */
  ...
  /* the desired orientation state of the submarine (updated internally through
   * pose lock system) */
