...
class ChangeStateBehavior
    : public BT::RosServiceNode<guppy_msgs::srv::ChangeState> {
 public:
  ChangeStateBehavior(const std::string& name,
  ...
  bool setRequest(Request::SharedPtr& request) override {
    ...
    RCLCPP_INFO(logger(), "Requesting state change to '%u'.",
  ...
  BT::NodeStatus onResponseReceived(
    ...
    RCLCPP_INFO(logger(),
                "%s response received from ChangeState action server.",
