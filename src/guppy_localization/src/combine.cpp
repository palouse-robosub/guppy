 ...
 public:
  CombineSensors() : Node("combine_sensors") {
    imu_subscription_ = this->create_subscription<sensor_msgs::msg::Imu>(
        "/vectornav/imu", 10,
        std::bind(&CombineSensors::imu_callback, this, std::placeholders::_1));
    dvl_subscription_ = this->create_subscription<nav_msgs::msg::Odometry>(
        "/waterlinked_dvl_driver/odom", 10,
        std::bind(&CombineSensors::dvl_callback, this, std::placeholders::_1));
    baro_subscription_ = this->create_subscription<
        geometry_msgs::msg::PoseWithCovarianceStamped>(
        "/barometer", 10,
        std::bind(&CombineSensors::baro_callback, this, std::placeholders::_1));
  ...
  void dvl_callback(nav_msgs::msg::Odometry::SharedPtr msg) {
    ...
    Eigen::Vector3d twist(msg->twist.twist.linear.x, msg->twist.twist.linear.y,
    ...
    Eigen::Vector3d omega(odom.twist.twist.angular.x,
  ...
  void imu_callback(sensor_msgs::msg::Imu::SharedPtr msg) {
    ...
    Eigen::Quaternion orientation(msg->orientation.w, msg->orientation.x,
                                  msg->orientation.y, msg->orientation.z);
    Eigen::Vector3d twist(msg->angular_velocity.x, msg->angular_velocity.y,
