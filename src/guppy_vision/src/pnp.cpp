 ...
 public:
  PerspectiveNPoint() : Node("pnp") {
    corner_sub_ =
        this->create_subscription<guppy_msgs::msg::CornerDetectionList>(
            ...
            std::bind(&PerspectiveNPoint::callback, this,
                      std::placeholders::_1));
    info_sub_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
        "/cam/test/camera_info", 10,
        std::bind(&PerspectiveNPoint::info_callback, this,
                  std::placeholders::_1));
  ...
  void callback(guppy_msgs::msg::CornerDetectionList::UniquePtr msg) {
    ...
    for (int result_i = 0; result_i < msg->detections.size(); result_i++) {
      ...
      for (int dimension_i = 0; dimension_i < detection.dimension_points.size();
           dimension_i++) {
      ...
      cv::solvePnP(objectPoints, imagePoints, k, d, rvec, tvec, 0,
      ...
      Eigen::Vector3d axis(rvec.at<double>(0, 0), rvec.at<double>(1, 0),
                           rvec.at<double>(2, 0));
      axis.normalize();
