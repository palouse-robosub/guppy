      ...
      Node("state_manager"), current_state_(guppy_msgs::msg::State::STARTUP) {
        ...
        estopsubscription_ =
            this->create_subscription<guppy_msgs::msg::CanFrame>(
                "/can/id_0x1b", 10,
                std::bind(
                    &StateManager::estopcallback, this, std::placeholders::_1
                )
            );
        resetholdpose =
        ...
        state_publisher_ = this->create_publisher<guppy_msgs::msg::State>(
            "state", state_quality
        );    // ROS2 QoS let's you tell the topic to hold
        ...
        state_service_ = this->create_service<guppy_msgs::srv::ChangeState>(
            "change_state", std::bind(
                                &StateManager::transition_callback, this,
                                std::placeholders::_1, std::placeholders::_2
                            )
        );
        timer_ = this->create_wall_timer(
            1ms, std::bind(&StateManager::on_timer, this)
        );
        ...
        this->nav_subscription_ =
            this->create_subscription<geometry_msgs::msg::Twist>(
                "cmd_vel/nav", 10, nav_callback
            );
        this->task_subscription_ =
            this->create_subscription<geometry_msgs::msg::Twist>(
                "cmd_vel/task", 10, task_callback
            );
